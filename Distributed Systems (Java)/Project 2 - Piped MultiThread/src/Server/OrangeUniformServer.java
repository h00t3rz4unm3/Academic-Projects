...
public class OrangeUniformServer extends Thread
	{
		private String name;
		private int number;
		...
		OrangeUniformServer(String name)
			{
				super(name);
		...
		OrangeUniformServer(String name, int number)
			{
				super(name + " " + number);
		...
		OrangeUniformServer(String name, int number, ServerMonitor monitor)
			{
				super(name);
		...
		public void printMessage(String message)
			{
				System.out.println("[" + (System.currentTimeMillis() - startTime) + "] " + name + " " + number + ": " + message);
			}
				...
				try
					{
						...
						sleep(randomNumberGenerator(100, 50));
					}
				catch (InterruptedException e)
					{
		...
		public void printInfo()
			{
				System.out.println("Student " + name + " " + number + " attended " + attendedParades.size() + " parades and saw " + attendedShows.size() + " circus shows");
