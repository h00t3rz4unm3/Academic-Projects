...
public class BlueUniformStudent extends Thread
	{
		private String name;
		private int number;
		...
		BlueUniformStudent(String name)
			{
				super(name);
		...
		BlueUniformStudent(String name, int number)
			{
				super(name + " " + number);
		...
		BlueUniformStudent(String name, int number, Monitor monitor)
			{
				super(name);
