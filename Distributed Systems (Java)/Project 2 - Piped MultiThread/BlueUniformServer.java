...
public class BlueUniformServer extends Thread
	{
		private String name;
		private int number;
		...
		BlueUniformServer(String name, int number)
			{
				super(name + " " + number);
		...
		BlueUniformServer(String name, int number, ServerMonitor monitor)
			{
				super(name);
